...
The cleanest integration is a module-style asset source:

- Standalone planner stores `HomePlan` JSON and preview thumbnails.
- Export creates either a compact `procedural://home-plan/<planId>?seed=...` URL
  or an expanded `procedural://building-custom?...` URL for small plans.
