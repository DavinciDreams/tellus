...
export interface ProcPlantBiomePatch {
  ...
  asset?: ProcPlantBiomeAsset;
}

export interface ProcPlantBiomeAsset {
  libraryId: string;
  lodPreference: "lod2" | "lod3";
  color?: number;
}
...
export const GLOBAL_DEFAULT_FERN_ASSET_IDS = [
  "2b64b91a-cc16-4b03-afef-7f09cbf3a0cc",
  "80b4a76f-27f4-4ba3-bb63-47c54f5995b9",
] as const;
...
const globalDefaultCandidate = (
  ...
  if (entry.primary === "phiFern") {
    const warmFern = entry.environment.biomeWarmth >= 0.72;
    return {
      ...entry,
      primary: warmFern ? "compactStylizedFern" : "compactFern",
      secondary: undefined,
      hybrid: 0,
      treeBackend: undefined,
      asset: {
        libraryId: warmFern
          ? GLOBAL_DEFAULT_FERN_ASSET_IDS[1]
          : GLOBAL_DEFAULT_FERN_ASSET_IDS[0],
        lodPreference: "lod2",
        color: warmFern ? 0x4f8f3d : 0x477b3f,
      },
    };
  }
  if (
...
const PAINT_BIOMES: Record<TerrainPaintKind, ProcPlantBiomeCandidate[]> = {
  meadow: [
    ...
    candidate("hillCherry", { density: 0.16, scale: 5.4, weight: 1, treeBackend: { kind: "lsystem", species: "hillCherry", leafScaleMultiplier: 2.0, maxLeaves: 260, maxStems: 78, maxBranchDepth: 3 }, environment: { light: 0.76, moisture: 0.56, crowding: 0.28, biomeWarmth: 0.66 } }),
  ],
  flowers: [
    ...
    candidate("hillCherry", { density: 0.14, scale: 4.8, weight: 1, treeBackend: { kind: "lsystem", species: "hillCherry", leafScaleMultiplier: 2.1, maxLeaves: 270, maxStems: 82, maxBranchDepth: 3 }, environment: { light: 0.78, moisture: 0.62, crowding: 0.32, biomeWarmth: 0.68 } }),
  ],
  grass: [
    ...
    candidate("oakCanopy", { density: 0.18, scale: 6.2, weight: 1, treeBackend: { kind: "lsystem", species: "cambridgeOak", leafScaleMultiplier: 2.9, maxLeaves: 320, maxStems: 90, maxBranchDepth: 3 }, environment: { light: 0.7, moisture: 0.5, crowding: 0.32, biomeWarmth: 0.58 } }),
    candidate("birchGrove", { density: 0.16, scale: 5.8, weight: 1, treeBackend: { kind: "lsystem", species: "silverBirch", leafScaleMultiplier: 3.9, maxLeaves: 290, maxStems: 76, maxBranchDepth: 3 }, environment: { light: 0.72, moisture: 0.52, crowding: 0.28, biomeWarmth: 0.5 } }),
  ],
  beach: [
  ...
  dirt: [
    ...
    candidate("acaciaUmbrella", { density: 0.14, scale: 5.8, weight: 1, treeBackend: { kind: "lsystem", species: "sassafras", leafScaleMultiplier: 3.25, maxLeaves: 270, maxStems: 78, maxBranchDepth: 3 }, environment: { light: 0.82, moisture: 0.34, crowding: 0.2, biomeWarmth: 0.76 } }),
  ],
  "forest-floor": [
    ...
    candidate("oakCanopy", { density: 0.18, scale: 6.5, weight: 1, treeBackend: { kind: "lsystem", species: "cambridgeOak", leafScaleMultiplier: 2.8, maxLeaves: 310, maxStems: 88, maxBranchDepth: 3 }, environment: { light: 0.46, moisture: 0.58, crowding: 0.56, biomeWarmth: 0.5 } }),
  ],
  "desert-sand": [
    ...
    candidate("acaciaUmbrella", { density: 0.1, scale: 5.8, weight: 1, treeBackend: { kind: "lsystem", species: "sassafras", leafScaleMultiplier: 3.05, maxLeaves: 220, maxStems: 64, maxBranchDepth: 3 }, environment: { light: 0.92, moisture: 0.18, crowding: 0.12, biomeWarmth: 0.88 } }),
  ],
  rock: [
