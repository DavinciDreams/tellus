...
export interface TellusWorldModuleTimelinePolicy {
  eras: readonly string[];
  defaultEra?: string;
  allowsPresentDay?: boolean;
...
export interface TellusWorldModuleAttachment {
  id: string;
...
export const TELLUS_WORLD_MODULES: readonly TellusWorldModuleDescriptor[] = [
  ...
  },
  {
    ...
    scopes: ["world", "object"],
    capabilities: ["asset-placement", "editable-plan", "terrain-editing", "biome-overlay"],
    stateAuthority: "world-state",
    assetPolicy: {
  ...
  },
  {
    ...
    summary: "Anchor a real-world terrain or 3D Tiles site with overlays for ruins, great houses, roads, artifacts, and landscape context.",
    scopes: ["world", "portal"],
    capabilities: [
      "geospatial-terrain",
      "reconstruction-layer",
    ...
    stateAuthority: "world-state",
    assetPolicy: {
      preferredCategories: ["terrain", "map-layer", "artifact", "reconstruction", "building", "environment"],
      uploadedByUser: true,
      assetStoreRequired: true,
      externalTilesAllowed: true,
    },
    timelinePolicy: {
      eras: ["present-day", "site-occupation", "reconstruction"],
      defaultEra: "present-day",
      allowsPresentDay: true,
      allowsReconstruction: true,
    },
    agentPolicy: {
      roles: ["guide", "archaeologist", "historian"],
      canGuide: true,
      canCoCreate: true,
    },
  },
  {
    id: "time-travel-site",
    label: "Time Travel Site",
    summary: "Switch a place between present-day terrain, historical reconstruction, and speculative restored states.",
    scopes: ["world", "portal"],
    capabilities: [
      "geospatial-terrain",
      "timeline-state",
    ...
    assetPolicy: {
      preferredCategories: ["terrain", "map-layer", "artifact", "reconstruction", "media"],
      uploadedByUser: true,
      assetStoreRequired: true,
      externalTilesAllowed: true,
    },
    timelinePolicy: {
      eras: ["present-day", "ancient", "excavation", "restored"],
      defaultEra: "present-day",
      allowsPresentDay: true,
      allowsReconstruction: true,
    },
    agentPolicy: {
      roles: ["guide", "historian", "referee"],
      canGuide: true,
      canReferee: true,
    },
  },
